...
### Instructions
Refer to [Problem.md](Problem.md) file for problem description. 
...
2. **CLONE** the forked repository, containing the boilerplate in your local machine
     ...
     `git clone <your_repository> appservice_cosmos`
     
3. Navigate to appservice_cosmos folder

    `cd appservice_cosmos`
